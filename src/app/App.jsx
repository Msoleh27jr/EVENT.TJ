...
import { DigetInfo, Digets, Events, EventsById, Home, Movie, MovieById, News, NewsById, PictureById, Pictures, Theatres, TheatresById, TheatresToday, TheatresTomorrow, TheatresWeek, Video, VideoById } from "./providers/lazy/lazy";
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="theatres/week" element={<TheatresWeek />} />
