    ...
    <>
      <section>
        ...
        <div className='my-[50px]'>
          ...
          <div className='flex items-start gap-[25px] flex-wrap'>
            {
              data.map((e) => {
                return (
                  <div className='w-[215px] h-[550px] group cursor-pointer' key={e.id}>
                    <div className='relative overflow-hidden rounded-lg'>
                      <img src={e.image} className='w-full object-center group-hover:scale-105 h-[325px] transition-transform duration-500 rounded-[10px] mb-[20px]' alt="image" />
                    ...
                    <div className='flex flex-wrap items-center gap-[5px]'>
                      {
                        e.genres.map((e) => {
                          return (
                            <h3 className='h-[30px] flex items-center justify-center group-hover:text-[#FAFAFA] transition-all duration-500 px-[5px] group-hover:bg-[#9F00FF] rounded-[8px] text-[14px]'>{e.genre}</h3>
                          )
                        })
                      }
                    </div>
