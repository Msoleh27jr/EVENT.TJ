                    ...
                    <div className='flex my-[50px] gap-[30px] flex-col'>
                        {data[id].collection.map((el, i) => (
                            <div key={i} className='flex flex-col gap-[20px]'>
                                ...
                                {el.conditions && (
                                    <p className='text-[18px]'><span className='font-[700]'>{t("conditions")}: </span>{el.conditions}</p>
                                )}
                                {el.time && (
                                    <p className='text-[18px]'><span className='font-[700]'>{t("time")}: </span>{el.time}</p>
                                )}
                                {el.address && (
                                    <p className='text-[18px]'><span className='font-[700]'>{t("address")}: </span>{el.address}</p>
                                )}
                                {el.phone && (
                                    <p className='text-[18px]'><span className='font-[700]'>{t("phone")}: </span>{el.phone}</p>
                                )}
                                {el.importnamt && (
                                    <p className='text-[18px]'><span className='font-[700]'>{t("important")}: </span>{el.importnamt}</p>
                                )}
                                {el.Instagram && (
                    ...
                    {recomended && recomended.map((el, i) => (
                        <div key={i} className='flex flex-row gap-[20px]'>
                            ...
                            <div className='flex flex-col gap-[10px]'>
                                ...
                                <p onClick={() => routeById(i)} className='text-[16px] font-[600] cursor-pointer hover:text-[#9F00FF]'>{el.name}</p>
                            </div>
                        </div>
                    ))}
                </div>
